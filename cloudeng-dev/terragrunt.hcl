...
# ----------------------------------------------------------------------------------------------------------------
# GENERATED PROVIDER VERSION BLOCK
# Hashicorp release aws provider 4.0+ and broke everything without any warning.
# See this issue: https://github.com/hashicorp/terraform-provider-aws/issues/20433
# Also this discussion: https://github.com/gruntwork-io/knowledge-base/discussions/187
# ----------------------------------------------------------------------------------------------------------------
